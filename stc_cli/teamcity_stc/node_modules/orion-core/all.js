...
var Core = {
    ...
    archive: {
        Client: require('./lib/archive/Client'),
        Server: require('./lib/archive/Server')
    },

    auth: {
        JIRA: require('./lib/auth/JIRA')
    },
    ...
    integration: {
        JiraClient: require('./lib/integration/JiraClient'),
        Client: require('./lib/integration/Client')
    },
    ...
    model: {
        ...
        archiveServer: {
            ArchiveServer: require('./lib/model/archiveServer/ArchiveServer')
        },
        ...
        test: {
            ...
            PageObject: require('./lib/model/test/PageObject'),
    ...
    test: {
        ...
        InBrowserRunner: require('./lib/test/InBrowserRunner'),
        SandboxRecorderRunner: require('./lib/test/SandboxRecorderRunner'),
        SandboxRunner: require('./lib/test/SandboxRunner'),
        InspectorRunner: require('./lib/test/InspectorRunner'),
        SandboxInspectorRunner: require('./lib/test/SandboxInspectorRunner')
    },
