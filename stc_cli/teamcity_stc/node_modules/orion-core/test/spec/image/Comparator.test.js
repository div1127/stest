...
describe('Comparator', function () {
    ...
    it('compares png files', function* () {
        var expected = xfs.resolve('test/helper/image/expected.png'),
            actual = xfs.resolve('test/helper/image/actual.png'),
            result;
    ...
    it('returns 0 diffCount when images are identical', function* () {
        var expected = xfs.resolve('test/helper/image/actual.png'),
            actual = xfs.resolve('test/helper/image/actual_copy.png'),
            result;
    ...
    it('compares large png files', function* () {
        var expected = xfs.resolve('test/helper/image/bigone.png'),
            actual = xfs.resolve('test/helper/image/bigone.png'),
            result;
    ...
    describe('asymetrical files diff', function () {
        var smallerPath = xfs.resolve('test/helper/image/smaller.png'),
            largerPath = xfs.resolve('test/helper/image/larger.png'),
