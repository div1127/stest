...
describe("Checking all panels", function() {
    ...
    // TODO: Fails on mobile due to error.  (iPhone 12 / iPad 12)
    xdescribe('Panels loaded, rendered and screenShot match', function () {
    ...
    // TODO: Fails on mobile (iPhone 12 / iPad 12)
    xdescribe('Checking panel location', function(){
        var panelDirection;
        beforeAll(function(){
    ...
    // TODO: Fails on mobile (iPhone 12 / iPad 12)
    xdescribe('Checking icons', function () {
        var numberOfButtons = 4;
        for(var panel = 0; panel < panels.length; panel++) {
            panelText = Components.panel(panels[panel]);
