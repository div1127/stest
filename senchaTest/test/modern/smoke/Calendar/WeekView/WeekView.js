 ...
 * @author Alexander Dracka
 * @created 2016/11/9
 * @edited 2016/11/22 by Michal Golis
 * @edited 2017/01/11 by Miroslav Meca
 * 
 ...
 *
 * @edited 2017/05/23 by Jiří Znoj
 * Tested on:
    ...
    if (Lib.isDesktop){
        describe('Desktop', function(){
            ...
            describe('Resizing/Editing events', function(){
                ...
                // TODO: fails on Win10 / IE 11
                xit('Resize due to change end time', function(){
                ...
                it('Resize due to change end time', function(){
                    ...
                    if(Lib.isPhone){
                        ST.component('calendar-form-edit fieldset').and(function(){
                            this.future.cmp.getScrollable().scrollTo(null, 200);
                        });
                    }
                    ST.component('calendar-timefield[_name=endTime]').visible().click();
                    if(Lib.isPhone){
