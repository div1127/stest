 ...
 * @edited 2016/08/16 by Vojtech Cerveny
 * @edited 2016/12/15 by Miroslav Meca
 * 
        ...
        scrollChartsElement: function(index){
            ST.component('charts').visible().and(function(){
                if(this.future.cmp.el.dom.scrollWidth < 740){
                    this.future.cmp.getScrollable().scrollTo(null, 300*index);
                } else {
                    this.future.cmp.getScrollable().scrollTo(null, (index%2)? 300*(index - 1)/2 : 300*index/2);
                }
            });
        },
        /**
