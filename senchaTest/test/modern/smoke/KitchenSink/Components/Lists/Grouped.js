...
describe("Grouped List", function() {
    ...
    it("should scroll down and up", function() {
        ...
        Comp.list()
            .and(function(list) {
                scrollTop = list.getScrollable().getPosition().y;
                expect(scrollTop).toBeGreaterThan(0);
                Comp.scrollTo(0);
            })
            .wait(function(list){
                return list.getScrollable().getPosition().y == Ext.first('itemheader').el.dom.clientHeight + Ext.first('itemheader').el.dom.clientTop;
            })
            .and(function(list) {
                scrollTop = list.getScrollable().getPosition().y;
