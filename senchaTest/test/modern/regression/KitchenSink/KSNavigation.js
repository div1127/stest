...
describe("Navigation", function() {
    ...
    describe("Details panel", function(){
        ...
        // TODO: Fails on Win 10 / Chrome 71
        xit("Should expand/collapse on tablet or desktop", function(){
            if(Lib.isDesktop){
                Stuff.sourceButton()
                    .click();
                Stuff.sourcecodePanel()
    ...
    describe("Get to example", function(){
        // TODO: Fails on Win 10 / Chrome 71
        xit("Should go to Toolbar example", function(){
            var name;
            var countChildren;
            if(Phone){
        ...
        // TODO: Fails on Win 10 / Chrome 71
        xit("Should go to Toolbar example and back", function(){
            if(Phone){
