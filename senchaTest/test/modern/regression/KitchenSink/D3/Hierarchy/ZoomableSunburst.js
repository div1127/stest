 ...
 * By Jiri Znoj - last update: 15. 2. 2016
 * tested on:
 *          desktop:
 *              Chrome 54
 *              Firefox 45
...
describe("Zoomable Sunburst", function(){
    ...
    // TODO: Timeout on multiple browsers
    xdescribe("Check if store is not changed", function(){
    ...
    // TODO: Timeout on multiple browsers
    xdescribe("Clicking on nodes in 1st level and check x-d3-selected (without Root)", function() {
    ...
    // TODO: Timeout on multiple browsers
    xdescribe("Clicking on nodes in 2nd level and check x-d3-selected", function(){
    ...
    // TODO: Timeout on multiple browsers
    xdescribe("Mouseover and check if tooltip text fits - 1st level", function(){
        afterEach(function(){
            if(!Lib.isDesktop){
                ST.wait(4*initialAnimationDelay);
                ST.component("d3-sunburst")
    ...
    // TODO: Timeout on multiple browsers
    xdescribe("Mouseover and check if tooltip text fits - 2nd level", function(){
        afterEach(function(){
            if(!Lib.isDesktop){
                ST.wait(4*initialAnimationDelay);
                ST.component("d3-sunburst")
    ...
    // TODO: Timeout on multiple browsers
    xdescribe("Verify 2-level tree - expanded is always true in non-leaf nodes", function(){
