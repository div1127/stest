...
describe("Line Chart", function() {
    ...
    describe(desc, function () {
        ...
        xit('Markers are getting bigger by mouseover / tap', function(){
            var length;
            var yAxis;
            ST.component('chart:first')
                .and(function (ch) {
                    yAxis = ch.getAxes()[0].oldRange[1] - ch.getAxes()[0].oldRange[0];
                    length = ch.getSeries()[0].getSurface().getItems()[0].dataMarker.instances.length;
        ...
        xit('Legend is working', function(){
        ...
        xit('Chart is movable to side (by x-axis)', function(){
            ddAndCheck(graph_id, 20, 80);
        });

        // TODO: Fails on Win 10 / IE 11
        xit('Chart is movable by window over chart preview under the chart', function(){
            ddAndCheck(graph_id2, 90, 10);
        });

        // TODO: Fails on Win 10 / IE 11
        xit('Chart is changing its width by changing window width under that chart', function(){
