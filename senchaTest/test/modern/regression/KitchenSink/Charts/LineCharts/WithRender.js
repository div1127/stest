...
describe("With Render", function() {
    ...
    describe(desc, function () {
        ...
        xit('Part from point to point on its right side, which has lower y value, has red color', function () {
            ST.component('chart')
                .and(function(c){
                    valueColor(c, false);
                });
        ...
        xit('Part from point to point on its right side, which has higher y value, has blue color', function () {
            ST.component('chart')
                .and(function(c){
                    valueColor(c, true);
                });
