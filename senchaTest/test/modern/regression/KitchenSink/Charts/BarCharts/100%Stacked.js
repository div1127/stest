/**
 * modern KS > Charts > Bar Charts > 100% Stacked
...
describe("100% Stacked", function() {
    ...
    beforeAll(function() {
        Lib.Chart.beforeAll("#bar-stacked-100")
            .and(function(){
    ...
    afterAll(function () {
        Lib.Chart.afterAll("bar-stacked-100", true);
    });
    //------------------------------------------------tests-----------------------------------------------------------//
    ...
    describe(desc, function () {
        ...
        it('Source click', function(){
            Lib.sourceClick('KitchenSink.view.chart.bar.Stacked100');
        })
    });
});