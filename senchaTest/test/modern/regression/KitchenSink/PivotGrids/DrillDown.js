 ...
 * @created 2016/09/13
 * @date 13.9.2016
 * @edited 2017/05/31 by Miroslav Meca
 *
...
describe('Pivot Grid - DrillDown example', function(){
    ...
    describe('DrillDown Window', function(){
        ...
        describe('Window', function(){
            ...
            describe('Grid - Scroll & click', function(){
                ...
                xit('is scrollable', function(){
                    Grid.DrillDown.scrollToRecord(40);
                    var scroller;
                    Grid.DrillDown.getGrid()
                        .visible()
                        .and(function(){
                            scroller = this.future.cmp.getScrollable().getPosition().y;
                        })
                        .wait(function(){
                            return scroller > 500;
                        })
                        .and(function(){
                            expect(scroller).toBeGreaterThan(500);
                        });
                });
                ...
                it('is scrolled by clicking on buttons', function(){
                    ...
                    Grid.DrillDown.getGrid()
                        .visible()
                        .wait(function(){
                            return this.cmp.getScrollable().getPosition().y !== 0;
                        })
                        .and(function(){
                            expect(this.future.cmp.getScrollable().getPosition().y).toBeGreaterThan(scroller);
                        });
                });
                it('is scrolled by clicking on slider', function(){
                    ...
                    Grid.DrillDown.getGrid()
                        .and(function(){
                            expect(this.future.cmp.getScrollable().getPosition().y).not.toBe(scroller);
                        });
                });
            });
    ...
    describe('Sortable', function(){
        ...
        // Grid.createDescribeForSorting((new Date().getFullYear()) - 2012 + 2);
