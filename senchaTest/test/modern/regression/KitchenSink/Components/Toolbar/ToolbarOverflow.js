...
describe("Toolbars Overflow", function() {
    ...
    if (Lib.isPhone) {
        ...
        xdescribe("Toolbar Top Overflowbar", function() {
            for(var i = 0; i < menuBar.length; i++){
                Lib.testButtons("",menuBar[i],1);
                Toolbar.panelTool('right',[i+1],1)
            }
        })

        describe("Toolbar Right Overflowbar", function() {
            for(var i = 0; i < menuBar.length; i++){
                Lib.testButtons("",menuBar[i],2);
                // Toolbar.menuButton(menuBar[i],i)
                Toolbar.panelTool('down',[i+1],2)
            }
        })
