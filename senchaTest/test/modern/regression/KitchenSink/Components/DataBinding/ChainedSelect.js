	...
	describe("Chained Select example", function() {
		...
		**/
		it("should have correct text", function() {
			var expectedText = "The states store contains all US states and Canadian provinces, however it filters based upon the id of the selected record in the country field.";
			Dash.contentText()
				.visible()
				.and(function(text) {
