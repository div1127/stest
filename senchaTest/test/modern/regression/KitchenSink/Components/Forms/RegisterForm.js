...
describe('RegisterForm', function(){
    ...
    describe('Fields editing', function() {
        ...
        xit('Pickerfield', function() {
            Form.statePicker()
                .type('ravnica')
                .and(function() {
                    expect(this.future.cmp.getValue()).toBe('ravnica');
                    expect(this.future.cmp._inputType).toBe('text');
                });
            Form.clear(7, true);
        });
    ...
    describe('Required fields', function() {
        ...
        for(var i=0; i<required.length; i++){
            xit('tooltip is displayed on' +fieldLabels[required[i]], function() {
